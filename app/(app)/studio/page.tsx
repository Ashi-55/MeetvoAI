...
import { ArrowLeft, ArrowRight, Check, Clock, Copy, Folder, Home, Mic, Plus, Send, Settings, Sparkles, Star, X } from 'lucide-react';
...
export default function StudioPage() {
  ...
  return (
    <main className="min-h-[calc(100vh-3.5rem)] bg-[radial-gradient(circle_at_50%_-10%,rgba(91,94,247,0.24),transparent_32rem),radial-gradient(circle_at_90%_20%,rgba(245,158,11,0.14),transparent_26rem),#090D1A] text-white">
      <aside className="fixed left-0 top-14 z-30 hidden h-[calc(100vh-3.5rem)] w-[272px] flex-col border-r border-[#26324A] bg-[#0E1424]/95 shadow-[18px_0_60px_rgba(0,0,0,0.22)] backdrop-blur-xl lg:flex">
        <div className="px-5 py-5">
          <div className="text-sm font-extrabold tracking-[-0.02em] text-white">MeetvoAI Studio</div>
        </div>

        <nav className="space-y-1 px-3">
          <Link href="/" className="flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-medium text-[#B7C2DD] hover:bg-[#202A44] hover:text-white">
            <Home className="h-4 w-4" /> Home
          </Link>
          <button className="flex w-full items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-medium text-[#B7C2DD] hover:bg-[#202A44] hover:text-white">
        ...
        <div className="mt-7 px-5 text-xs font-semibold uppercase tracking-[0.16em] text-[#8EA0C6]">Recent builds</div>
        <div className="mt-3 flex-1 space-y-1 overflow-y-auto px-3">
          {historyItems.length ? historyItems.map((item) => (
            <button
              ...
              className="flex w-full items-start gap-3 rounded-xl px-3 py-2.5 text-left hover:bg-[#202A44]"
            >
              <span className="mt-0.5 text-base">{item.icon}</span>
              <span className="min-w-0">
                <span className="block truncate text-sm font-medium text-white">{item.title}</span>
                <span className="mt-0.5 block text-xs text-[#8EA0C6]">{item.time}</span>
              </span>
            </button>
          )) : (
            <div className="rounded-xl border border-dashed border-[#26324A] px-3 py-4 text-sm text-[#8EA0C6]">No recent builds yet.</div>
          )}
        </div>

        <div className="border-t border-[#26324A] p-4">
          <div className="flex items-center gap-3">
            <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-[#5B5EF7] text-sm font-bold text-white">{userInitial}</div>
            <div className="min-w-0 flex-1">
              <div className="truncate text-sm font-medium text-white">{userEmail}</div>
              <Link href="/settings" className="mt-1 inline-flex items-center gap-1.5 text-xs text-[#8EA0C6] hover:text-[#F59E0B]">
      ...
      <div className="min-h-[calc(100vh-3.5rem)] lg:ml-[272px]">
        <div className="sticky top-14 z-20 flex items-center justify-between border-b border-[#26324A] bg-[#0E1424]/95 px-4 py-3 backdrop-blur lg:hidden">
          <div>
            <div className="text-sm font-extrabold text-white">MeetvoAI Studio</div>
            <div className="mt-0.5 max-w-[220px] truncate text-xs text-[#8EA0C6]">{userEmail}</div>
          </div>
          <Link href="/settings" className="flex h-9 w-9 items-center justify-center rounded-full border border-[#26324A] bg-[#151C31] text-[#8EA0C6]">
        ...
        {stage === 'input' ? (
          <section className="flex min-h-[calc(100vh-3.5rem)] flex-col items-center justify-center px-4 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-14">
            <div className="w-full max-w-[860px] text-center">
              <div className="mx-auto mb-5 inline-flex items-center gap-2 rounded-full border border-[#F59E0B]/25 bg-[#F59E0B]/10 px-4 py-2 text-xs font-bold uppercase tracking-[0.18em] text-[#F8C46D] shadow-[0_14px_40px_rgba(245,158,11,0.08)]">
                <Sparkles className="h-4 w-4" />
                AI Studio
              </div>
              <h1 className="mx-auto max-w-3xl text-4xl font-[900] leading-[1.02] tracking-[-0.04em] text-white sm:text-5xl lg:text-[64px]">Build your AI flow in plain language.</h1>
              <p className="mx-auto mt-5 mb-7 max-w-xl whitespace-pre-line text-sm leading-6 text-[#B7C2DD] sm:mb-9 sm:text-[17px]">
                {'Describe the business outcome. MeetvoAI drafts the workflow, preview, and deploy path.'}
              </p>
              ...
              <div className={`mx-auto w-full max-w-[780px] rounded-[24px] border bg-[#11182B]/92 px-4 pb-4 pt-5 text-left shadow-[0_30px_90px_rgba(0,0,0,0.34)] ring-1 ring-white/[0.03] transition sm:px-5 ${voiceStatus === 'listening' ? 'border-[#fb7185]' : 'border-[#2A3652]'}`}>
                <textarea
                  ...
                  className="max-h-[220px] min-h-[116px] w-full resize-none border-0 bg-transparent p-0 text-[17px] leading-7 text-white outline-none placeholder:text-[#7281A2]"
                ...
                <div className="mt-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                  <div className="flex min-w-0 items-center gap-2">
                    <button
                      ...
                      className="flex h-10 w-10 items-center justify-center rounded-xl text-[#B7C2DD] hover:bg-[#202A44] hover:text-[#F59E0B]"
                      aria-label="Add"
                    >
                    ...
                    <select
                      ...
                      className="min-w-0 max-w-[170px] flex-1 rounded-full border border-[#2A3652] bg-[#0B1020] px-3 py-2 text-sm font-medium text-[#B7C2DD] outline-none hover:border-[#F59E0B] hover:text-[#F8C46D]"
                    ...
                    <button
                      ...
                      className={`flex h-10 w-10 items-center justify-center rounded-xl transition ${voiceStatus === 'listening' ? 'text-[#e11d48] animate-pulse' : 'text-[#B7C2DD] hover:bg-[#202A44] hover:text-[#F59E0B]'}`}
                  ...
                  <button
                    ...
                    className="w-full rounded-[14px] bg-[#5B5EF7] px-6 py-3 text-sm font-bold text-white shadow-[0_16px_34px_rgba(91,94,247,0.28)] transition hover:bg-[#4B4EE8] disabled:pointer-events-none disabled:opacity-50 sm:w-auto"
                  >
              ...
              <div className="mt-7 flex flex-wrap items-center justify-center gap-3 text-sm text-[#B7C2DD]">
                ...
                {STARTERS.map((starter) => (
                  <button
                    ...
                    className="inline-flex items-center gap-2 rounded-full border border-[#2A3652] bg-[#11182B] px-4 py-2.5 text-sm font-semibold text-[#B7C2DD] shadow-[0_10px_30px_rgba(0,0,0,0.12)] hover:border-[#F59E0B] hover:text-[#F8C46D]"
                  >
              ...
              <div className="mx-auto mt-7 grid max-w-[760px] grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-3">
                {EXAMPLES.map((example) => (
                  <button
                    key={example}
                    type="button"
                    onClick={() => setPrompt(example)}
                    className="rounded-[14px] border border-[#2A3652] bg-[#11182B]/88 px-4 py-3 text-[13px] font-medium text-[#B7C2DD] transition hover:border-[#F59E0B] hover:bg-[#171F35] hover:text-[#F8C46D]"
                  >
                    {example}
                  </button>
                ))}
          ...
          <section className="flex min-h-[calc(100vh-3.5rem)] flex-col lg:flex-row">
            <div className="flex w-full flex-col border-b border-[#26324A] bg-[#0E1424]/95 lg:w-[35%] lg:min-w-[380px] lg:border-b-0 lg:border-r">
              <div className="flex items-center gap-3 border-b border-[#26324A] px-4 py-3 sm:px-5 sm:py-4">
                <button type="button" onClick={() => setStage('input')} className="rounded-xl p-2 text-[#B7C2DD] hover:bg-[#202A44] hover:text-white" aria-label="Back">
                  <ArrowLeft className="h-4 w-4" />
                </button>
                <div className="min-w-0">
                  <div className="truncate text-sm font-semibold text-white">{buildTitle}</div>
                  <div className="text-xs text-[#8EA0C6]">{mode || 'building'}</div>
                </div>
              </div>
              ...
              <div className="max-h-[45vh] space-y-4 overflow-y-auto px-4 py-4 sm:px-5 sm:py-6 lg:max-h-none lg:flex-1 lg:space-y-5">
                ...
                <div className="max-w-[96%] rounded-2xl border border-[#2A3652] bg-[#11182B] px-4 py-4 text-sm text-[#B7C2DD] shadow-sm lg:max-w-[90%]">
                  <div className="font-semibold text-white">{generating ? 'AI is thinking' : 'Here is what I built:'}</div>
                  {generating ? (
                    <div className="mt-3 flex gap-1">
                      {[0, 1, 2].map((dot) => (
                        <span key={dot} className="h-1.5 w-1.5 animate-bounce rounded-full bg-[#F59E0B]" style={{ animationDelay: `${dot * 120}ms` }} />
                      ))}
                    </div>
                  ) : (
                    <div className="mt-4 rounded-xl border border-[#2A3652] bg-[#090D1A] p-4">
              ...
              <div className="border-t border-[#26324A] p-3 sm:p-4">
                <div className="flex items-center gap-2 rounded-2xl border border-[#2A3652] bg-[#11182B] px-3 py-2">
                  <input
                    value={refinement}
                  ...
                  <button
                    ...
                    className="rounded-lg bg-[#5B5EF7] p-2 text-white hover:bg-[#4B4EE8] disabled:pointer-events-none disabled:opacity-50"
            ...
            <div className="flex min-h-[520px] w-full flex-col bg-[#090D1A] lg:w-[65%]">
              <div className="flex flex-col gap-3 border-b border-[#26324A] bg-[#0E1424]/95 px-4 py-3 sm:flex-row sm:items-center sm:justify-between sm:px-5">
                <div className="flex rounded-xl bg-[#11182B] p-1">
                  {(['preview', 'code'] as const).map((tab) => (
                    <button
                      key={tab}
                      type="button"
                      onClick={() => setActiveTab(tab)}
                      className={`rounded-lg px-4 py-2 text-sm font-semibold capitalize transition ${activeTab === tab ? 'bg-[#26324A] text-white shadow-sm' : 'text-[#B7C2DD] hover:text-white'}`}
                    >
                      {tab}
                    </button>
                  ))}
                ...
                <div className="flex items-center gap-2">
                  {deployUrl ? (
                    <button type="button" onClick={copyDeployUrl} className="flex-1 rounded-xl border border-[#2A3652] bg-[#11182B] px-4 py-2 text-sm font-semibold text-[#B7C2DD] hover:border-[#F59E0B] hover:text-[#F8C46D] sm:flex-none">
                      Copy URL
                    </button>
                  ) : null}
                  <button type="button" onClick={() => setShowDeployModal(true)} className="flex-1 rounded-lg bg-[#5B5EF7] px-4 py-2 text-sm font-semibold text-white hover:bg-[#4B4EE8] sm:flex-none">
              ...
              <div className="min-h-[460px] flex-1 overflow-hidden p-3 sm:p-5">
                {generating ? (
                  <div className="flex h-full flex-col items-center justify-center rounded-3xl border border-[#2A3652] bg-[#11182B] p-8 text-center">
                    <div className="mb-4 h-8 w-8 animate-spin rounded-full border-2 border-[#26324A] border-t-[#F59E0B]" />
                    <div className="text-sm font-semibold text-white">Generating your build...</div>
                    <div className="mt-8 w-full max-w-2xl space-y-4">
                      <div className="h-5 w-2/3 animate-pulse rounded-full bg-[#26324A]" />
                      <div className="h-5 w-1/2 animate-pulse rounded-full bg-[#26324A]" />
                      <div className="h-64 animate-pulse rounded-2xl bg-[#26324A]" />
                    </div>
                  </div>
                ) : activeTab === 'preview' ? (
                  isAutomation ? (
                    <div className="h-full overflow-auto rounded-3xl border border-[#2A3652] bg-[#11182B] p-6">
                      {workflow ? (
                        <WorkflowDiagram automation={workflow} animate />
                      ) : (
                        <div className="flex h-full items-center justify-center text-sm text-[#B7C2DD]">Workflow preview will appear here.</div>
                      )}
                    </div>
                  ) : (
                    <iframe
                      ...
                      className="h-full w-full rounded-3xl border border-[#2A3652] bg-white"
                    />
                  )
                ) : (
                  <div className="h-full overflow-hidden rounded-2xl bg-[#0f172a] text-[#e2e8f0]">
                    <div className="flex items-center justify-between border-b border-white/10 px-4 py-3">
                      ...
                      <button type="button" onClick={copyCode} className="rounded-lg bg-[#5B5EF7] px-3 py-2 text-xs font-semibold text-white hover:bg-[#4B4EE8]">
      ...
      {showDeployModal ? (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 px-4 backdrop-blur-sm">
          <div className="w-full max-w-md rounded-3xl border border-[#2A3652] bg-[#11182B] p-6 shadow-[0_24px_80px_rgba(0,0,0,0.4)]">
            <div className="mb-5 flex items-start justify-between gap-4">
              <div>
                <h2 className="text-xl font-bold text-white">Deploy your agent</h2>
                <p className="mt-1 text-sm text-[#B7C2DD]">Choose your live MeetvoAI subdomain.</p>
              </div>
              <button type="button" onClick={() => setShowDeployModal(false)} className="rounded-xl p-2 text-[#B7C2DD] hover:bg-[#202A44] hover:text-white">
                <X className="h-4 w-4" />
              </button>
            </div>

            <label className="text-sm font-semibold text-white">Subdomain</label>
            <div className="mt-2 flex items-center rounded-2xl border border-[#2A3652] bg-[#090D1A] px-3 py-2 focus-within:border-[#F59E0B]">
              <input
                value={subdomain}
              ...
              />
              <span className="text-sm text-[#B7C2DD]">.meetvoai.in</span>
            </div>

            <div className="mt-5 rounded-2xl border border-[#2A3652] bg-[#090D1A] p-4 text-sm text-[#B7C2DD]">
            ...
            <button
              ...
              className="mt-6 w-full rounded-xl bg-[#5B5EF7] px-4 py-3 text-sm font-semibold text-white hover:bg-[#4B4EE8] disabled:pointer-events-none disabled:opacity-50"
            >
