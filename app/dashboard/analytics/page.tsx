        ...
        <section className="rounded-3xl border border-[#1E1B3A] bg-[#090C16] p-8">
          <div className="flex items-start justify-between">
            <div>
              ...
              <p className="mt-2 text-sm text-[#8A9BB5] max-w-2xl">
            ...
            <div className="flex gap-3">
              <Link href="/dashboard" className="rounded-2xl bg-[#4F8EF7] px-5 py-3 text-sm font-semibold text-[#08080F]">
                Back to Dashboard
              </Link>
            </div>
          </div>
          ...
          <div className="mt-8 grid gap-4 sm:grid-cols-3">
            <div className="rounded-2xl border border-[#1A1F2B] bg-[#0C1220] p-5">
              <div className="text-sm text-[#8A9BB5]">Total Agents</div>
            ...
            <div className="rounded-2xl border border-[#1A1F2B] bg-[#0C1220] p-5">
              <div className="text-sm text-[#8A9BB5]">Revenue</div>
              <div className="mt-3 text-3xl font-bold">—</div>
            </div>
          </div>

          <div className="mt-6 text-sm text-[#8A9BB5]">
